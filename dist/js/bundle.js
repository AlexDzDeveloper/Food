  ...
  function getDynamicInformation(selector) {
    ...
    input.addEventListener('input', function () {
      ...
      if (input.value.match(/\D/g)) {
        //якщо користувач ввів НЕ число, то...
    ...
    _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        if (this.classes.length === 0) {
          //робимо перевірку, так як метод classes у будь-якому випадку поверне масив, навіть пустий. Тому перевіряємо довжину масиву
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  var showModalWindows = document.querySelectorAll(triggerSelector),
  ...
  showModalWindows.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return openModal(modalSelector, modalTimerId);
    }); //стрілкова ф-ція в даному випадку необхідна для того, щоб виклик call-back ф-ції openModal з використанням селектора modalSelector був виконаний тільки після кліка, а не одразу
  });
  ...
  document.addEventListener('keydown', function (e) {
    ...
    if (e.code === 'Escape' && modal.classList.contains('show')) {
      //використовуємо порівняння коду натиснутої клавіші із кодом, який відповідає клавіші Esc (Escape)
      closeModal(modalSelector);
    }
  });
...
function slider(_ref) {
  ...
  next.addEventListener('click', function () {
    ...
    if (offset == deleteNotDigits(width) * (slides.length - 1)) {
      //Робимо за допомогою regExp, виконуємо заміну НЕ чисел на пустий рядок (тобто забираємо 'px')
      offset = 0;
    } else {
      //додаємо зміщення
  ...
  prev.addEventListener('click', function () {
    //Коли на останнбому слайді - на початок. Перетворюємо на число
    if (offset == 0) {
      //повертаємо на останній слайд, коли знаходимось на першому слайді
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    //присвоюємо значення за замовчуванням 0 (стандарт ES6). Якщо приходить якийсь інший аргумент - підставиться він
  ...
  tabsParrent.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains(tabsSelector.slice(1))) {
      //використовуємо метод slice для того, щоб не було помилки і видалити крапку, так як тут звернення безповередньо до класу
...
function timer(id) {
  ...
  function getTimeRemaining(endtime) {
    ...
    var t = Date.parse(endtime) - Date.parse(new Date()); //отримуємо числове значення в мілісекундах, віднімаючи від заданої дати поточну дату
  ...
  function getZero(num) {
    var item = document.querySelectorAll('.timer__block span');
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      var t = getTimeRemaining(endtime); //результат ф-ції getTimeRemaining - {} з необхідними величинами
...
/* harmony import */ var _js_modules_calc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/modules/calc */ "./src/js/modules/calc.js");
...
/* harmony import */ var _js_modules_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/modules/modal */ "./src/js/modules/modal.js");
